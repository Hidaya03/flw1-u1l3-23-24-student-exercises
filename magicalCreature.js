...
let creatureName = "Modern day chicken";

// 2. Declare a variable named 'creatureDescription' and describe its magical properties as a string.
let creatureDescription = "Devolved T-Rex with a nasty attitude";
...
let zooSummary = "The " + creatureName + " is " + creatureDescription + " it is " +isFriendly + " if the visitor is " + visitorAge + " only " + canVisit + "year olds can visit this creature."
